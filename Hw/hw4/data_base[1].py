        ...
        for i in self.db[0]:
            for value in i.values():
                for key, val in value.items():
                    books.append(key)
        print(f' count of all books : {len(books)}')
...
class Database:
    ...
    def add_writer(self, writer):
        ...
        self.db[1][0]['Writer'].update({writer.code_writing: writer_db})
        with open('Database.pkl', 'wb') as writer:
            pickle.dump(self.db, writer)
    ...
    def add_poet(self, poet):
        ...
        self.db[1][2]['Poet'].update({poet.poet_id: poet_db})
    ...
    def add_researcher(self, researcher):
        ...
        self.db[1][1]['Researcher'].update({researcher.researcher_id: researcher_db})
        with open('Database.pkl', 'wb') as w:
            pickle.dump(self.db, w)
    ...
    def add_book(self, book):
        ...
        self.db[0][0]['Book'].update({book.ISBN: book_db})
    ...
    def add_poem(self, poem):
        ...
        self.db[0][1]['Poem'].update({poem.poem_id: poem_db})
    ...
    def add_article(self, article):
        ...
        self.db[0][2]['Article'].update({article.article_id: article_db})
...
# b = Book('math', 334, 'Gaj')
# db.add_book(b)
# a = Article('gravity', 'NewYork', 2021)
# db.add_article(a)
# a = Book('history', 223, 'jangle')
